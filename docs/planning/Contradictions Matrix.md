...
| Topic | Old value | Old source | Current value | Controlling source | Status | Treatment |
|---|---|---|---|---|---|---|
| Land value / basis | $12.0M prior listing; $11.1M appraisal ($290/SF) | S6 (pp.1, 5) | $8.0M working opening input; no adopted ceiling or walk-away | D-P1; S2 `Assumptions!B18`; S3 `Assumptions!D7`; S8 p.7 | current working assumption (strategy input); appraisal opinion preserved | **D-P1 ratifies only the $8.0M working opening input.** Appraisal and third-party ranges remain context; authority, ceiling, walk-away, and conditions unresolved |
